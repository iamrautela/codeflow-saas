...
import { Code2, ArrowLeft, X, Mail, Phone } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          animate={{
            background: [
              "radial-gradient(circle at 20% 50%, rgba(59, 130, 246, 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(139, 92, 246, 0.3) 0%, transparent 50%), radial-gradient(circle at 40% 80%, rgba(6, 182, 212, 0.2) 0%, transparent 50%)",
              "radial-gradient(circle at 80% 50%, rgba(59, 130, 246, 0.3) 0%, transparent 50%), radial-gradient(circle at 20% 20%, rgba(139, 92, 246, 0.3) 0%, transparent 50%), radial-gradient(circle at 60% 80%, rgba(6, 182, 212, 0.2) 0%, transparent 50%)",
              "radial-gradient(circle at 20% 50%, rgba(59, 130, 246, 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(139, 92, 246, 0.3) 0%, transparent 50%), radial-gradient(circle at 40% 80%, rgba(6, 182, 212, 0.2) 0%, transparent 50%)"
            ]
          }}
          transition={{
      ...
      <Link 
        href="/" 
        className="absolute top-6 left-6 z-20 text-gray-400 hover:text-white transition-colors group"
      >
        <motion.div
      ...
      <motion.div
        ...
        animate="visible"
      >
        <div className="bg-gray-900/40 backdrop-blur-xl rounded-3xl p-8 border border-gray-700/30 shadow-2xl">
          {/* Close button */}
          <Link href="/">
            <motion.button
          ...
          >
            <motion.button
              ...
              className="flex items-center justify-center py-4 bg-gray-800/50 hover:bg-gray-700/50 rounded-xl transition-all duration-300 group"
